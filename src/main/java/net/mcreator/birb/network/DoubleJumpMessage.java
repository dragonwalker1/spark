...
import net.mcreator.birb.procedures.DoubleJumpOnKeyPressedProcedure;
...
public class DoubleJumpMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		BirbMod.addNetworkMessage(DoubleJumpMessage.class, DoubleJumpMessage::buffer, DoubleJumpMessage::new, DoubleJumpMessage::handler);
	}
}
