...
import net.mcreator.birb.procedures.DashOnKeyPressedProcedure;
...
public class DashMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		BirbMod.addNetworkMessage(DashMessage.class, DashMessage::buffer, DashMessage::new, DashMessage::handler);
	}
}
